...
namespace Tuan4_NguyenKhanhNhat.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult GioHang()
        {
            ...
            ViewBag.Tongsoluongsan = TongSoLuongSanPham();
        ...
        {
            List<Giohang> lstGiohang = Laygiohang();
            Giohang sanham = lstGiohang.SingleOrDefault(n => n.masach == id);
            if(sanham != null)
            {
        ...
        public ActionResult CapnhatGioHang(int id, FormCollection collection)
        {
            ...
            if (sanham != null)
            {
                sanham.iSoluong = int.Parse(collection["txtSoLg"].ToString());
            }
            return RedirectToAction("GioHang");
        }
